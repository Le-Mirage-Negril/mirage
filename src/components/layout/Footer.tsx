    ...
    <footer className="bg-cyan-950 text-stone-400 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/weddings" className="hover:text-amber-500 transition-colors">
                  Weddings
                </a>
              </li>
              <li>
                <a href="/reservations" className="hover:text-amber-500 transition-colors">
                  Book a Room
                </a>
              </li>
            </ul>
          ...
          <div>
            <h4 className="text-lg font-medium text-white mb-4">Other Resources</h4>
            <ul className="space-y-2">
              <li>
                <a
        ...
        <div className="border-t border-stone-800 mt-12 pt-8 text-center">
          <p>© {new Date().getFullYear()} Le Mirage Negril. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
