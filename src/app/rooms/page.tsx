          ...
          <AnimatedSection delay={0.6}>
            <div className="w-full max-w-3xl mx-auto pb-20">
              <p className="text-center font-semibold">
                All rooms come fully equipped with a ceiling fan, A/C, cable television,
                refrigerator, coffee maker and a spacious bathroom. King and double beds are
                available. Free Wifi is also available throughout the entire property.
              </p>
            </div>
          </AnimatedSection>
        </section>
